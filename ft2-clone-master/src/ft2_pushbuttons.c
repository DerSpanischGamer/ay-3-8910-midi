...
pushButton_t pushButtons[NUM_PUSHBUTTONS] =
{
	...
	*/
	...
	{ 168, 62, 18, 13, 1, 4, "X",				NULL,    NULL,			NULL },
	{ 185, 62, 18, 13, 1, 4, "X",				NULL,    NULL,			NULL },
	{ 253, 34, 18, 13, 1, 4, "X",				NULL,    NULL,			NULL },
	...
	{ 294, 104, 59, 16, 0, 0, "NOP",		NULL,    NULL,       NULL },
	{ 294, 121, 59, 16, 0, 0, "NOP",		NULL,    NULL,       NULL },	// S.E.Ext.
	{ 294, 138, 59, 16, 0, 0, "NOP",		NULL,    NULL,       NULL },
...
void drawPushButton(uint16_t pushButtonID)
{
	...
	pushButton_t *b = &pushButtons[pushButtonID];	// Get the push button
	if (!b->visible)
		return;
